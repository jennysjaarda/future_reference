...
knitr::include_graphics("images/LD_score_LD_intuition.png")
```
...
```{r echo=FALSE, out.width = '50%',fig.align='left'}
knitr::include_graphics("images/LD_score_drift_intuition.png")
```
...
```{r , echo=FALSE, out.width = '50%',fig.align='left'}
knitr::include_graphics("images/LD_score_derivation1.png")
```
...
```{r , echo=FALSE, out.width = '50%',fig.align='left'}
knitr::include_graphics("images/LD_score_assumptions.png")
```
...
```{r , echo=FALSE, out.width = '50%',fig.align='left'}
knitr::include_graphics("images/LD_score_derivation2.png")
```
...
```{r , echo=FALSE, out.width = '50%',fig.align='left'}
knitr::include_graphics("images/LD_score_derivation3.png")
```
...
```{r , echo=FALSE, out.width = '50%',fig.align='left'}
knitr::include_graphics("images/LD_score_partioning_h2_overview.png")
```

- Gives an LD score for each category.

```{r , echo=FALSE, out.width = '50%',fig.align='left'}
knitr::include_graphics("images/LD_score_partioning_h2_derivation.png")
```

- Estimate tau via multiple regression with LD score computed from reference.

```{r , echo=FALSE, out.width = '50%',fig.align='left'}
knitr::include_graphics("images/LD_score_overview.png")
```

...
knitr::include_graphics("images/bayes_eg1_remove_sims.png")
```
...
```{r , echo=FALSE, out.width = '50%',fig.align='left'}
knitr::include_graphics("images/bayes_eg1_prior_posterior.png")
```
...
```{r , echo=FALSE, out.width = '50%',fig.align='left'}
knitr::include_graphics("images/bayes_eg1_summary.png")
```
...
```{r , echo=FALSE, out.width = '50%',fig.align='left'}
knitr::include_graphics("images/bayes_beta_dist.png")
``` 
...
```{r , echo=FALSE, out.width = '50%',fig.align='left'}
knitr::include_graphics("images/bayes_eg2_informative_prior.png")
```
